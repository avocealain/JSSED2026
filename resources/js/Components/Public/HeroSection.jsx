                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        <p className="mt-5 text-xl sm:text-2xl font-medium text-gray-700 dark:text-gray-300 tracking-widest transition-colors duration-300">
                            J · S · S · E · D — ENSPD · UNIVERSITÉ DE PARAKOU
                        </p>
                        ...
                        <div className="mt-12 flex flex-col sm:flex-row justify-center items-center gap-4">
                            ...
                            <a href="call-for-papers" className="w-full sm:w-auto inline-block px-8 py-3 border-2 border-emerald-600 text-emerald-600 hover:bg-emerald-600 hover:text-white dark:border-emerald-500 dark:text-emerald-400 dark:hover:bg-emerald-500 dark:hover:text-white font-semibold rounded-lg transition-colors duration-300">
