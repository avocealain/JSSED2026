                        ...
                        <div className="mt-12 flex flex-col sm:flex-row justify-center items-center gap-4">
                            ...
                            <a 
                              ...
                              onClick={(e) => {
                                ...
                                link.href = '/documents/Appel_a_communications_JSSED_ENSPD_EDSAE_UP_2026_v15052026.pdf';
                                link.download = 'Guide_Appel_Communications_2026.pdf';
                                link.click();
                              }}
                             title="Télécharger la version officielle de l'appel à candidature" className="w-full sm:w-auto inline-block px-8 py-3 border-2 border-emerald-600 text-emerald-600 hover:bg-emerald-600 hover:text-white dark:border-emerald-500 dark:text-emerald-400 dark:hover:bg-emerald-500 dark:hover:text-white font-semibold rounded-lg transition-colors duration-300">
